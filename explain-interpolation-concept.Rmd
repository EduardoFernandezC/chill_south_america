---
title: 'How to: Chill Interpolation'
author: "L. Caspersen"
date: "5/4/2021"
...
Values of original and interpolated correction variable were inserted to extract the associated chill. Then associated chill of the interpolated correctin variable is substracted from the SWC of original proxy, resulting in a map showing in which regions chill should by added or substracted from the map of interpolated SWC. Blue areas show regions in which SWC should be added to kriged SWC and red areas show where chill should be substracted. 
...
Results were evaluated using the method of repeated k-fold crossvalidation (5 repitions and k=7).
