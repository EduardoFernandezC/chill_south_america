...
future_chill <- read.csv('southamerica_chill/chill_south_america/data/future_safe_chill.csv')
...
write.csv(all_proejctions,'southamerica_chill/chill_south_america/data/all_chill_projections.csv', row.names = FALSE)
